...
var Projections = React.createClass({
	...
	componentWillMount: function () {
		...
		if (this.changeColor("") == "rgba(0, 204, 0, )") {
			...
			this.setState({
				alert: "Sorry, according to your life-style you will either need to cut back or gain $" + String(Math.ceil(((ItemStore.getGoal() - (ItemStore.getNet()* ItemStore.getMonths()))/ItemStore.getMonths()).toFixed(2))) + " more a month or add at most "+ String(Math.ceil(ItemStore.getGoal() / ItemStore.getNet()) - ItemStore.getMonths()) + " " + months +" to your savings plan."
			})
		}
	},
